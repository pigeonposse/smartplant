...
describe( '@smartplant/ventilation', () => {

	it( 'installs on a plant and adjustVentilation() produces advice', async () => {
		...
		const result = await plant.plugin( 'ventilation' ).adjustVentilation( {} )
