...
// 7777 by preference, but an example that dies because something else is
// already listening is a bad example — and it is the first thing anyone running
// two plants will hit. Port 0 asks the OS for whatever is free.
const server = await plant.serve( { port : 7777 } ).catch( async err => {

	console.log( `${err.message}\nTaking a free one instead.\n` )
	return plant.serve( { port : 0 } )
