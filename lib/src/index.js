...
// ── units ────────────────────────────────────────────────────────────────────
// Display only. Everything below the display is Celsius and stays there.
export {
	UNITS, SENSOR_UNITS, toC, toF,
	formatTemperature, temperatureValue, temperatureBand,
	temperatureSymbol, plausibleTemperature, resolveUnits,
} from './units/index.js'
...
export {
	BANDS, BAND_IDS, PROBE_ORDER, band, contraindications, crossBandDiagnosis,
	describeBands, foldCycles, interpret, phaseLocking, probePeriodSanity,
	SPECTRAL_VERDICT, SpectralSafety, SpectralSystem,
} from './spectral/index.js'

// The light *drivers* live behind `smartplant/spectral`: serial and mqtt carry
// optional dependencies, so they stay out of the root import.
