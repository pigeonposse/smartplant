...
export const DEVICES = {
	...
	'lidar-360' : d( {
		...
		support   : SUPPORT.DECLARED,
		notes : 'For a plant that moves. This library defines what a map has to guarantee before a pot is allowed to cross it and delegates the mapping itself — a scanning lidar belongs with ROS2 and Nav2, which have spent a decade on the problem. See the navigation layer.',
	} ),
