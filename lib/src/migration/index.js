...
export {
	ALL_MODULES, compareConditions, exportBundle, MIN_SPAN, MODULES,
	SCHEMA_VERSION, summarizeConditions,
} from './bundle.js'

export { importBundle, Inheritance } from './graft.js'

export {
	canTeach, experienceOf, isNovice, mergeLessons, prepareLesson,
} from './teaching.js'
...
export {
	describeIdentity, exportIdentity, importIdentity, PARTS, TIED_TO,
} from './identity.js'
