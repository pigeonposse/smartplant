...
export {
	FADES_OVER_DAYS, HEMISPHERE, SEASON, SEASONAL, seasonalRanges,
	seasonalWeight, seasonFromHistory, seasonNow,
} from './season.js'

export {
	confirm as confirmWatering, dose, potVolume, pumpSeconds,
	SUBGROUP_WATERING, WATERING,
} from './watering.js'

export {
	BASELINE_DAYS, dryingRate, ROOT_SPACE, rootSpace, TYPICAL_DAYS,
	wateringInterval,
} from './rootspace.js'
export {
	assess as assessTransplant, describe as describeTransplant,
	MAX_SETTLING_DAYS, MIN_SETTLING_DAYS, PHASE as TRANSPLANT_PHASE, RESETS,
