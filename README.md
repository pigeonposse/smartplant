...
- **[What worked last time](#-what-worked-last-time)** · **[Night consolidation](#-night-consolidation)** · **[System diagnosis](#-system-diagnosis)** · **[Looking at itself](#-looking-at-itself)** · [Maintenance](#-maintenance--the-health-of-the-instrument) · **[Learning it is wrong](#-learning-it-is-wrong)** · [Knowledge transfer](#-knowledge-transfer) · [Reading the electrome](#-reading-the-electrome)
...
| `thermal` | a frame callback | The whole canopy at once — see [Vision](#-vision) |
